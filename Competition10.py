import pandas as pd
from sklearn.ensemble import RandomForestRegressor, GradientBoostingRegressor, StackingRegressor, ExtraTreesRegressor, AdaBoostRegressor
...
def main():
    ...
    out_file(test_predictions, id, 'stacking_predictions4.csv')
