...
def main():
    ...
    important_features = [feature_names[i] for i in range(len(feature_names)) if feature_importances[i] > 0.01]
    print("Important features:", important_features)

    x_train = pd.DataFrame(x_train, columns=feature_names)[important_features]
    x_test = pd.DataFrame(x_test, columns=feature_names)[important_features]
